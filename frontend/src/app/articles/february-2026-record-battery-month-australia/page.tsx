          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-6 leading-tight">
                February 2026 Smashes Battery Records:{' '}
                <span className="text-[#F9A825]">1.2 GWh</span> Installed in a Single Month
              </h1>
              <p className="text-xl text-white/90 mb-6">
                Australia registered a record 1.2 GWh of home battery storage in February 2026 — up 24% on
                January — as homeowners rush to beat the May 1 rebate deadline. Every state saw increased uptake.
              </p>
            ...
            >
              <div className="relative h-64 sm:h-96 rounded-2xl overflow-hidden border border-gray-200 shadow-lg">
                <Image
                  ...
                  alt="Home battery installation - February 2026 record month"
                  fill
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            >
              ...
              <h2 className="text-3xl md:text-4xl font-display font-bold text-white mb-6">
                Don&apos;t Miss the{' '}
                <span className="text-[#F9A825]">Record Rebate Window</span>
              </h2>

              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                With battery demand at all-time highs and the May 1 deadline approaching, installation
                slots are filling fast. Get a free consultation from Super Solar Energy today.
              </p>
