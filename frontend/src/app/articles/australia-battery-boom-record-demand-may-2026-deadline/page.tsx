        ...
        <div className="bg-white pt-8 pb-4">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <nav className="text-sm text-gray-500">
              ...
              <span className="mx-2">&gt;</span>
              <span className="text-gray-700">Australia\'s Battery Boom Hits Record Highs — and the May ...</span>
            </nav>
          </div>
        </div>
        ...
        <div className="bg-white py-8">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl">
              <p className="text-sm text-gray-500 mb-3">March 2026 &middot; 7 min read</p>
              <h1 className="text-3xl sm:text-4xl font-display font-bold text-[#1a2332]">
                Australia\'s Battery Boom Hits Record Highs — and the May 1 Deadline Is Weeks Away
              </h1>
            </div>
          </div>
        </div>
