          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-6 leading-tight">
                ...
                <span className="text-[#F9A825]">Every State, Every Dollar, Every Deadline</span>
              </h1>
          ...
          >
            ...
            <div className="bg-[#E8621A] rounded-2xl p-8 sm:p-12 text-center mt-12">
              <h2 className="text-2xl sm:text-3xl font-display font-bold text-white mb-4">
                Lock In Your <span className="text-[#F9A825]">Maximum Rebate</span> Before May 2026
              </h2>
              <p className="text-lg text-white/90 mb-8 max-w-2xl mx-auto">
                As a CEC-accredited installer, Super Solar Energy handles everything &mdash; from rebate claims
